...
namespace
{
using rw_file_shm = ouroboros::shm_file<ouroboros::shm_access::read_write>;
using ro_file_shm = ouroboros::shm_file<ouroboros::shm_access::read_only>;

auto make_rw_file() -> rw_file_shm
{
    return rw_file_shm{ouroboros::shm_backing::file};
}

auto make_ro_file() -> ro_file_shm
{
    return ro_file_shm{ouroboros::shm_backing::file};
}
...
TEST(test_shm_file_backed, writer_and_reader)
{
    ...
    ro_file_shm reader_shm = make_ro_file();
